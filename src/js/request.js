...
export default class Request {
  ...
  ticketById(id) {
    return new Promise((resolve, reject) => {
      ...
      params.append('id', id);
      xhr.open('GET', `https://ahj-http1-bk.herokuapp.com/?method=ticketById&id=${id}`);
  ...
  createTicket(name, description) {
    return new Promise((resolve, reject) => {
      ...
      const xhr = new XMLHttpRequest();
      xhr.open('POST', 'https://ahj-http1-bk.herokuapp.com/?method=createTicket');
  ...
  removeById(id) {
    return new Promise((resolve, reject) => {
      ...
      const params = new URLSearchParams();
      params.append('id', id);
      xhr.open('DELETE', `https://ahj-http1-bk.herokuapp.com/?method=removeById&id=${id}`);
  ...
  editTicket(id, name, description) {
    return new Promise((resolve, reject) => {
      ...
      params.append('description', description);
      console.log(params);
      xhr.open('POST', `https://ahj-http1-bk.herokuapp.com/?method=editTicket&id=${id}`);
